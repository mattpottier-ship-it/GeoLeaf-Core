...
import { resolveField, compareByOrder, getLog, getActiveProfile } from '../../utils/general-utils.js';
     ...
     */
    function sortConfigByOrder(config: any) {
     ...
     */
    function resolveBadgeLabel(poi: any, field: any, value: any) {
     ...
     */
    function getDefaultTitle(poi: any) {
    ...
    function isDebugEnabled(context = 'popup') {
        ...
        return !!(debugFlags as any)[context];
    }
     ...
     */
    function isEmptyValue(value: any, options: any = {}) {
        const {
            allowZero = true,
     ...
     */
    function getValidFieldValue(poi: any, field: any, options: any = {}) {
        const resolveField = getResolveField();
     ...
     */
    function wrapInDiv(content: any, className: any) {
     ...
     */
    function createBadge(text: any, style = '') {
     ...
     */
    function createImage(src: any, alt: any, className = 'gl-poi-popup__photo') {
        const escapeHtml = getEscapeHtml();
     ...
     */
    function createLink(href: any, text: any, options: any = {}) {
        const escapeHtml = getEscapeHtml();
        const {
            external = false,
    ...
    const Helpers = {
        ...
        __setDebugWindow: (win: any) => { _testWindow = win; }
    };
