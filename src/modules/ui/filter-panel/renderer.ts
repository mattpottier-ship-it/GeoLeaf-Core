...
FilterPanelRenderer.populateTagsBadges = function (panelEl: any, allTags: any) {
    ...
    allTags.forEach(function (tag: any) {
        const badgeClickHandler = function (this: any) {
...
FilterPanelRenderer._loadAccordionContentIfNeeded = function (
     ...
     */
    function _setHtmlContent(area: any, html: any) {
     ...
     */
    function _setMessage(area: any, className: any, text: any) {
        while (area.firstChild) area.removeChild(area.firstChild);
