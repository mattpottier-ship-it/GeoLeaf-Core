...
_g.GeoLeaf.init = function (options: any) {
    try {
...
_g.GeoLeaf.setTheme = function (theme: any) {
    try {
...
_g.GeoLeaf.loadConfig = function (input: any) {
    if (
        input === null ||
        input === undefined ||
...
_g.GeoLeaf.removeMap = function (id: any) {
    const ctrl = _g.GeoLeaf._APIController;
    if (
        ctrl &&
        ctrl.managers &&
