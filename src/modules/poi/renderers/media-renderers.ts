...
class MediaRenderers extends AbstractRenderer {
     ...
     * @returns {HTMLElement}
     */
    _createThumbnail(imgUrl: any, index: any, mainImg: any, mainDiv: any, thumbsDiv: any) {
        const thumbDiv = this.createElement(
            "div",
