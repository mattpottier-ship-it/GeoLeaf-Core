...
} from "./utils/event-listener-manager.js";
...
// Animation shortcuts
_g.GeoLeaf.animate = (...args: any[]) => (getAnimationHelper() as any).animate(...args);
_g.GeoLeaf.fadeIn = (...args: any[]) => (getAnimationHelper() as any).fadeIn(...args);
_g.GeoLeaf.fadeOut = (...args: any[]) => (getAnimationHelper() as any).fadeOut(...args);
// PerformanceProfiler shortcuts
_g.GeoLeaf.mark = (name: any) => getPerformanceProfiler().mark(name);
_g.GeoLeaf.measure = (name: any, s: any, e: any) => getPerformanceProfiler().measure(name, s, e);
...
_g.GeoLeaf.loadModule = (name: any, path: any, opts: any) =>
    getLazyLoader().loadModule(name, path, opts);
_g.GeoLeaf.enableLazyImages = (selector: any) => getLazyLoader().enableImageLazyLoading(selector);
