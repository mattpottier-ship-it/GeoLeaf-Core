...
class AbstractRenderer {
    ...
    declare _eventListeners: (() => void)[];
    declare _initialized: boolean;
    declare _stateMap: WeakMap<HTMLElement, any>;
    ...
    getSecurity() {
        if (
            _gl.GeoLeaf &&
            _gl.GeoLeaf.Security &&
            typeof _gl.GeoLeaf.Security.escapeHtml === "function"
        ) {
        ...
        return {
            ...
            setSafeHTML: (element: any, html: any) => {
                if (!element) return;
                if (
                    _gl.GeoLeaf &&
                    _gl.GeoLeaf.DOMSecurity &&
                    typeof _gl.GeoLeaf.DOMSecurity.setSafeHTML === "function"
                ) {
    ...
    getUtils() {
        if (
            _gl.GeoLeaf &&
            _gl.GeoLeaf.Utils &&
            typeof _gl.GeoLeaf.Utils.resolveField === "function"
        ) {
            return _gl.GeoLeaf.Utils;
        }
        // Fallback resolveField implementation
        return {
            resolveField: (obj: any, ...paths: any[]) => {
                if (!obj) return null;
    ...
    getActiveProfile() {
        if (
            _gl.GeoLeaf &&
            _gl.GeoLeaf.Config &&
            typeof _gl.GeoLeaf.Config.getActiveProfile === "function"
        ) {
     ...
     */
    createElement(tagName: any, className: any, attributes: any = {}) {
     ...
     */
    createTextElement(tagName: any, text: any, className: any) {
     ...
     */
    createHTMLElement(tagName: any, html: any, className: any) {
        const element = this.createElement(tagName, className);
    ...
    removeAllEventListeners() {
        this._eventListeners.forEach((cleanup: () => void) => cleanup());
        this._eventListeners = [];
    }
     ...
     */
    setState(element: any, state: any) {
        if (element) {
     ...
     */
    updateState(element: any, updates: any) {
        if (element) {
