    ...
    const ProfileModule = {
        ...
        loadActiveProfileResources(options = {}) {
            ...
            return Loader.fetchJson(`${baseUrl}/profile.json?t=${timestamp}`, fetchOptions)
                .then((profile) => {
                    // Utiliser la logique de détection du ProfileV3Loader pour cohérence
                    const isV3 = GeoLeaf._ProfileV3Loader && GeoLeaf._ProfileV3Loader.isV3Profile(profile);

                    if (isV3) {
                        Log.info("[GeoLeaf.Config.Profile] Profil v3.0 détecté - Chargement modulaire");
        ...
        _loadV3Profile(profile, baseUrl, timestamp, fetchOptions) {
            ...
            return GeoLeaf._ProfileV3Loader.loadV3Profile(
                ...
                Log.info("[GeoLeaf.Config.Profile] Profil v3.0 chargé avec succès", {
                    profileId,
                ...
                if (enrichedProfile.taxonomy && enrichedProfile.taxonomy.categories) {
                    ...
                    Log.info("[GeoLeaf.Config.Profile] Taxonomie chargée depuis v3.0", {
        ...
        /**
         * Retourne les configurations de couches chargées depuis le profil actif v3.0
         *
         * @returns {Array|null}
         */
