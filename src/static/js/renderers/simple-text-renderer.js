...
(function (global) {
    ...
    if (!GeoLeaf._Renderers.AbstractRenderer) {
        throw new Error('AbstractRenderer must be loaded before SimpleTextRenderer');
    }
    ...
    // Export to namespace
    GeoLeaf._Renderers.SimpleTextRenderer = SimpleTextRenderer;

    if (GeoLeaf.Log) {
        GeoLeaf.Log.info('[GeoLeaf._Renderers.SimpleTextRenderer] Example renderer loaded');
    }
