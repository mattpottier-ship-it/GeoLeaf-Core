...
(function (global) {
     ...
     * Délègue à Security.escapeHtml si disponible.
     *
    ...
    function getPopupConfig(poi) {
        ...
        Log.warn && Log.warn('[POI Popup] Aucune configuration detailPopup trouvée pour POI:', poi.id || 'unknown');
        return null;
    }
    ...
    Log.info && Log.info('[GeoLeaf._POIPopup] Module POI Popup/Tooltip chargé (v2.0.0)');
