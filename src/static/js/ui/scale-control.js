...
(function (global) {
    ...
    const ScaleControl = {
        ...
        init(map, options = {}) {
            ...
            try {
                ...
                const showScale = GeoLeaf.Config?.get("ui.showScale");
                if (showScale === false) {
                ...
                const scaleType = GeoLeaf.Config?.get("ui.scaleType");
                if (scaleType) {
        ...
        _createNumericScale() {
            const NumericScaleControl = L.Control.extend({
                ...
                onAdd: (map) => {
                    ...
                    map.on("move", this._boundUpdateNumericScale);
                ...
                onRemove: (map) => {
                    ...
                    if (this._boundUpdateNumericScale) {
                        ...
                        map.off("move", this._boundUpdateNumericScale);
    ...
    GeoLeaf.UI.ScaleControl = ScaleControl;
