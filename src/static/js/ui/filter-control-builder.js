...
window._attachCategoryTreeListeners = function(container) {
    // Event listeners pour les flèches d'expansion
    ...
    // Event listeners pour les checkboxes de catégorie (parent)
    ...
    // Event listeners pour les checkboxes de sous-catégorie (enfant)
