...
(function (global) {
    ...
    /**
     * Get resolveField utility from GeoLeaf.Utils
     * @returns {Function}
     */
    ...
    /**
     * Get escapeHtml security utility
     * @returns {Function}
     */
    ...
    /**
     * Get active profile from Config module
     * @returns {Object|null}
     */
    ...
    /**
     * Sort config array by order property
     * Extracted from popup/tooltip/panel renderers (duplicated 4 times)
     *
     ...
     * @property {string} type - Item type (text, image, badge, etc.)
     * @property {string} field - Field path in POI data
     * @property {number} [order=999] - Sort order (lower = earlier)
     *
     * @example
     * const sorted = sortConfigByOrder([
     *   { type: 'text', field: 'title', order: 2 },
     *   { type: 'image', field: 'photo', order: 1 },
     *   { type: 'badge', field: 'category' } // order defaults to 999
     * ]);
     * // Returns: [image, text, badge]
     */
    ...
    GeoLeaf._ContentBuilder.Helpers = {
        // Dependency resolution
        getResolveField,
        getEscapeHtml,
        getActiveProfile,
    ...
    if (getLog()) {
        getLog().info('[GeoLeaf._ContentBuilder.Helpers] Module Helpers chargé');
    }
