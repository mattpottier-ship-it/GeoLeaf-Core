...
(function (global) {
    ...
    Log.info('[GeoLeaf._ContentBuilder.Templates] Module Templates chargé - 14 builders disponibles');

    // Vérification de l'export
    if (!GeoLeaf._ContentBuilder || !GeoLeaf._ContentBuilder.Templates) {
        Log.error('[GeoLeaf._ContentBuilder.Templates] ERREUR: Export échoué!');
    } else {
        Log.info('[GeoLeaf._ContentBuilder.Templates] Export confirmé - Templates.createMetricElement:', typeof GeoLeaf._ContentBuilder.Templates.createMetricElement);
    }
