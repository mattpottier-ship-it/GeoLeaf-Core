...
(function (global) {
    ...
    /**
     * Résout un chemin de type "attributes.longDescription" dans un objet POI.
     * Retourne undefined si le chemin n'existe pas.
     *
     * @param {object} poi - Objet POI source.
     * @param {string} fieldPath - Chemin en notation pointée (ex: "attributes.description").
     * @returns {*} Valeur résolue ou undefined.
     */
