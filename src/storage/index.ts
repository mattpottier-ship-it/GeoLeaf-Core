...
export function setItem(key: any, value: any, ttlMs?: any) {
    if (!isLocalStorageAvailable()) return false;
    try {
        const expires =
            ttlMs !== undefined && ttlMs != null && ttlMs > 0
...
export function getItem(key: any, defaultValue: any = null) {
...
export function hasItem(key: any) {
    if (!isLocalStorageAvailable()) return false;
    try {
        const raw = localStorage.getItem(_key(key));
...
export function setItems(items: any, ttlMs?: any) {
...
export function getItems(keyList: any, defaultValue: any = null) {
